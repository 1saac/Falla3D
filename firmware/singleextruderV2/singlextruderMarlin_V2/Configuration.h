...
//120v 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
//from pidautotune
    #define  DEFAULT_bedKp 381.36//97.1
    #define  DEFAULT_bedKi 54.77//1.41
    #define  DEFAULT_bedKd 633.90//1675.16
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {81.0000, 81.0000, 4045, 90.1}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {400, 400, 5, 60}    // (mm/sec){400, 400, 2, 60}
